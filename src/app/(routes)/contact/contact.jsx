    ...
    <div className="container-margin-compact ">
      <section className="top-section-p">
        <h1 className="text-2xl font-semibold sm:text-3xl md:text-4xl lg:text-5xl">
          <span className="">Get in Touch:</span> Drop us a line for your
          inquiries
        </h1>
      </section>
            ...
            <div className="space-y-8 ">
              {menuData[3].items.map((info, index) => (
                <a
                  ...
                  key={index}
                  href={info.link}
                  className="flex items-center space-x-4 transition-all duration-200 cursor-pointer hover:text-primary-orange-300 link w-fit "
                >
                  <FontAwesomeIcon
                  ...
                  />
                  <p
                    className={`text-lg sm:text-lg transition-all duration-200  hover:text-primary-orange-300 text-black-shade-300 tracking-wider font-semibold relative overflow-hidden lg:text-lg`}
                  >
                    {info.title}
                  </p>
                </a>
              ...
              <div className="flex items-center col-span-2 gap-4 sm:gap-4">
                {socialInfo.map((socialInfo, index) => (
                  <a
                    ...
                    className="flex items-center justify-center text-3xl transition-all duration-200 rounded-full shadow-md hover:bg-primary-orange-300 w-11 h-11 sm:text-2xl lg:text-2xl bg-black-shade-300 text-white-shade-200 hover:text-primary-accent"
