...
export default function featureSection(props) {
  ...
  return (
    <section
      ...
      } min-h-screen sm:py-28 md:py-32 lg:py-36 duration-[1300ms]`}
    >
      <h2
        className={`${
          isDarkTheme ? "text-white-shade-200" : "text-black-shade-300"
        } sm:mb-16 leading-tight text-center mb-10 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium`}
      >
        Why Clients Choose Us?
      </h2>
      <div className="flex flex-col md:gap-16 lg:gap-20 sm:flex-row container-margin-compact">
        <div className="relative w-full sm:mb-[20px] md:mt-14 md:mb-[150px]">
          <div className="flex flex-col gap-14 max-w-[500px]  sm:gap-36 md:gap-44 lg:gap-44 ">
        ...
        <div
          className={`sm:flex justify-center w-full items-center hidden feature-sticky-image-container `}
        >
          {imageWidth ? (
            <div>
              <Lottie
