  ...
  return (
    <div>
      <section className="container-margin-compact top-section-p">
        ...
        <div className="flex flex-col items-center justify-between w-full gap-2 lg:gap-20 lg:mt-20 md:gap-12 sm:flex-row sm:mt-16">
          <figure>
            <img
          ...
          <div className="flex flex-col gap-1 sm:gap-2 md:gap-3">
            <h2 className="text-2xl font-semibold leading-normal sm:text-2xl lg:text-4xl md:text-3xl">
              Our Long Term Vison
            </h2>
            <p className="w-full text-lg md:min-w-p[350px] lg:min-w-[400px] text-black-shade-200 leading-relaxed md:text-base lg:text-lg  max-w-[550px]">
      ...
      <section className="py-16 margin-t bg-black-shade-300 ">
        <div className="flex items-center justify-center container-margin">
          <div className="flex max-w-[900px] flex-col items-center w-full gap-8 sm:gap-16 sm:flex-row">
            ...
            <hr className="hidden border-none h-24 w-[0.4rem] bg-black-shade-100" />
            <Counter darkMode={true} number={5} title="Years" unit="+" />
          </div>
        </div>
      </section>
      <section className="bg-background-black padding-y-lg ">
        <h2 className="mt-10 text-2xl font-medium text-center md:text-3xl lg:text-5xl text-white-shade-200 mb-28">
          Our Timeline
        </h2>
